# -*- encoding: utf-8 -*-
# stub: activesupport 8.0.4.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v8.0.4.1/activesupport/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v8.0.4.1/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v8.0.4.1/activesupport" } if s.respond_to? :metadata=
